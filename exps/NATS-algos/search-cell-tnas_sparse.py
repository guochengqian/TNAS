...
def main(config):
    ...
    # TODO: rewrite paper, give a squential operation how to search. 
    # now, grouping based on alpha.
    # first, removing all operations whose alpha is lower than 0. 
    ...
    # second, a grouping based on the importance.
    group_lists = []
