...
'''
######################################################################################
# python exps/NAS-Bench-201-algos/TNAS.py --cfg cfgs/search_darts/gradient/tnas.yaml wandb.entity=xxx wandb.use_wandb=True
######################################################################################
...
def main(config):
    ...
    model_config = dict2config(
        dict(
            ...
            train_arch_parameter=config.model.train_arch_parameter, 
        ),
        None,
    )
    ...
    supernet.set_cal_mode(config.model.forward_mode)
